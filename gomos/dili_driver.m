...
% Tiangang Cui, 01/Sep/2021

[model, obs, prior] = setup_gomos_GP();
vmap                = get_map_matlab(model, obs, prior, zeros(prior.DoF, 1));
...
redu_def.init           = vmap; 
redu_def.eigen_Nmax     = prior.DoF;    % maximumn number of eigenvector for each local eigendecomposition
