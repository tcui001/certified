function [x,FVAL,EXITFLAG,OUTPUT,GRAD,HESSIAN] = fminunc_2020a(FUN,x,options,varargin)
...
options.UseParallel = optimget(options,'UseParallel',defaultopt,optimgetFlag); 
