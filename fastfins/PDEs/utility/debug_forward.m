...
d1 = zeros(obs.Nt*obs.N_obs,param.DoF);
d2 = zeros(obs.Nt*obs.N_obs,param.DoF);
...
for i = 1:10
    ...
    dx = dxdy.*dz;
    wx = GN_fd * dx;
    w_GN_fd  = wx.*dxdy + g_GN_fd.*dx2dy2.*dz + prior.beta*prior.P*dz;
